#
# This file implements an infrastructure to support building kconfig based
# components via dedicated *.mk files. It is based on the generic-component
# infrastructure, and inherits all of its features.
#
# Based on Buildroot's kconfig package infrastructure:
# https://git.busybox.net/buildroot/tree/package/pkg-kconfig.mk
#
...
define kconfig-package-merge-config
	...
	$(Q)util/merge_config.sh -m -O $(dir $(2)) $(2) $(3)
	$(call kconfig-package-regen-dot-config,$(1))
endef

#
# Generates the make targets needed to support a kconfig package.
#
# Arg1: lowercase component name
# Arg2: uppercase component name
#
define kconfig-component-helper
...
$(1)-diff-config: $(1)-check-configuration-done
	...
	$$(call kconfig-package-merge-config,$(2),$$($(2)_DIR)/$$($(2)_KCONFIG_DOTCONFIG),\
		$$($(2)_KCONFIG_FRAGMENT_FILES))
	$$(Q)util/diffconfig $$($(2)_DIR)/$$($(2)_KCONFIG_DOTCONFIG) \
...
endef # kconfig-component-helper

# The target generator macro for kconfig components.
kconfig-component = $(call kconfig-component-helper,$(pkgname),$(call UPPERCASE,$(pkgname)))
