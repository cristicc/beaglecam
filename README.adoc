...
--
[WARNING]
For the moment, the Camera Module in the schematics is generic and, therefore,
doesn't match the OV7670 hardware pin layout.
...
| P9_19     | I2C2_SCL    | uart1_rtsn    | Mode_3      | I2C2_SCL        | SIO_C
| P9_20     | I2C2_SDA    | uart1_ctsn    | Mode_3      | I2C2_SDA        | SIO_D
|===
