...
Please run the commands bellow to install all the packages the build environment
relies on:
...
(keep pressing the SPACE key while reseting the board) and run the following
